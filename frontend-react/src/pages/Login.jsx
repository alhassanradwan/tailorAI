...
//           <span className="gradient-text">Let AI Adapt to You</span>
//         </h1>
//         <p className="hero-subtitle">
//           Traditional courses teach everyone the same way. AdaptiveAI analyzes how YOU learn best, then personalizes every question, explanation, and challenge to match your skill level, learning style, and goals. Four specialized AI agents work together to accelerate your mastery of Data Science, ML, and Deep Learning.
//         </p>
...
//           {error && <div className="auth-error" style={{ color: 'var(--error)', textAlign: 'center', marginBottom: 12, fontSize: 14 }}>❌ {error}</div>}
...
//                 <input type="password" value={signupConfirm} onChange={(e) => setSignupConfirm(e.target.value)} placeholder="Repeat password" required />
//               </div>
//               <button type="submit" className="btn-primary btn-full" disabled={loading}>
